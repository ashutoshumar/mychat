...
import activity.ViewFullImageActivity
...
class ChatsAdapter(val context: Context,val chatList: List<Chat>,val imageUrl:String):RecyclerView.Adapter<ChatsAdapter.ViewHolder?>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
     ...
     Picasso.get().load(imageUrl).into(holder.imgMessageItemLeftProfile)
        ...
        inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
            var imgMessageItemLeftProfile: CircleImageView? =
                view.findViewById(R.id.imgMessageItemLeftProfile)
